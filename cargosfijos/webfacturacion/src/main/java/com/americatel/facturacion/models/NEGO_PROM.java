 ...
 * @author crodas
 */
public class NEGO_PROM  extends Historial {
    private Integer CO_NEGO_PROM;
    ...
    @JsonProperty("CO_NEGO_PROM")
    public Integer getCO_NEGO_PROM_ForJSON() {
        return CO_NEGO_PROM;
    }
    ...
    public void setCO_NEGO_PROM(Integer CO_NEGO_PROM) {
        this.CO_NEGO_PROM = CO_NEGO_PROM;
    }
