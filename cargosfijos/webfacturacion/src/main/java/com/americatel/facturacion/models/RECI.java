...
import com.americatel.facturacion.core3.ReciboPdf;
 ...
 */
@Component
public class RECI  extends Historial {
    ...
    @JsonIgnore
    public void save() {
        mapReci.insertar(this);
    }
    
    @JsonIgnore
    public NEGO getNegocio(){
        return mapReci.getNegocio(this);
    }

    @JsonIgnore
    public SUCU getPrimeraSucursalFacturada() {
        return mapReci.getPrimerSucursalFacturada(this);
    }
    
    @JsonIgnore
    public Integer getCantidadSucursalesFacturaron(){
        Integer cantidad = mapReci.getCantidadSucursalesFacturaronByReci(this.CO_RECI);
        if(cantidad==null){
            cantidad=0;
        }
    ...
    public void generarReciboModificadoPDF(HttpServletResponse response) {
        Recibo reci=new Recibo(this,null);
        ReciboModificadoPdf fp=new ReciboModificadoPdf(reci);
        fp.crearPdf();
        fp.cerrarCoss();
        fp.setName(reci.getNombreRecibo());
        fp.save(response);
    ...
    public List<RECI_GLOS> getGlosas() {
        return mapReci_Glos.getByRECI(this.CO_RECI);
    }
    ...
    */
    ...
    public void updateMontos() {
        RECI.mapReci.updateMontos(this);
    }
    
    @JsonIgnore
    public CIER_DATA_PLAN getPlanFromDiferencial() {
        return RECI.mapReci.getPlanFromDiferencial(this.CO_RECI);
    }
    
    @JsonIgnore
    public Integer getCantidadPuntos() {
        return RECI.mapReci.getCantidadPuntos(this.CO_RECI);
    }
    ...
    public CIER_DATA_SUCU getPlanDescription_SS() {
        return RECI.mapReci.getPlanDescription_SS(this.CO_RECI);
    }
}
