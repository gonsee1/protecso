Ext.onReady(function(){
    ...
    fnc.load.ModelsAndStores(["PROD","CIER","CLIE","BOLE","TIPO_DOCU","MONE_FACT","RECI_GLOS","NEGO_SUCU","TIPO_GLOS"],function(){
        var package="Desktop.Facturacion.Panels.CIER.MantenimientoBoleta";
        var varSendPackage=settings.Permissions.varSendPackage;
        var storeRef=new Desktop.Facturacion.Stores.BOLE();
        ...
        fnc.setApiProxyStore(storeRef,{read:'findBoleta/'}); 
        storeRef.load();
        storeTipoDocu.load({
            callback:function(){
                Ext.define(package,{
//                    extend:'Ext.panel.Panel',
                    ...
                    alias:'widget.Desktop.Facturacion.Panels.CIER.MantenimientoBoleta',
//                    enableLocking: true,
//                    bodyPadding: 5,
//                    width: 1100,
//                    style:{
...
//                    },
                    store:storeRef,
                    columns: [
                        {text:'Número',dataIndex:'CO_BOLE',width:125},
                        ...
                        }, "-",
                        {
                            ...
                            handler:function(){
                                ...
                                if(selected.length==1){
                                    ...
                                    fnc.setApiProxyStore(storeGlosas,{read:'getByBOLE/'});
                                    fnc.setApiProxyStore(storeNegoSucus,{read:'getByBOLE/'});
                                    console.log(data);
                                    storeNegoSucus.load({
                                        params:data,
                                        callback:function(){
                                            storeGlosas.load({
                                                ...
                                                callback:function(){
                                                    var win=fnc.createWindow({
                                                       title:'Editando boleta '+data.CO_BOLE,
                                                       width:850,
                                                       items:[
                                                           {
                                                               xtype:'form',
                                                                                               ...
                                                                                               buttons:[
                                                                                                   {
                                                                                                       ...
                                                                                                       handler:function(){
                                                                                                            ...
                                                                                                            values.CO_BOLE=data.CO_BOLE; 
                                                                                                            values[varSendPackage]=package;
                                                                                                            Ext.Ajax.request({
                                                                                                                method:'POST',
                                                                                                                params:values,
                                                                                                                url: settingsLocal.AJAX_URI+'BOLE/addGlosa/',
                                                                                                    ...
                                                                                                    buttons:[
                                                                                                        {
                                                                                                            ...
                                                                                                            handler:function(){
                                                                                                                ...
                                                                                                                Ext.Ajax.request({
                                                                                                                    method:'POST',
                                                                                                                    params:values,
                                                                                                                    url: settingsLocal.AJAX_URI+'BOLE/updateGlosa/',
                                                                                                                    success: function(response, opts) {
                                                                                                                       var json=fnc.responseExtAjaxRequestMsjError(response);
                                                                                                                        if(json.success){
                                                                                                                           w.close();
                                                                                        ...
                                                                                        fnc.createMsgConfirm({msg:'¿Esta seguro que lo desea eliminar?',call:function(a){
                                                                                            if (a=='yes'){
                                                                                                ...
                                                                                                Ext.Ajax.request({
                                                                                                    method:'POST',
                                                                                                    params:values,
                                                                                                    url: settingsLocal.AJAX_URI+'BOLE/deleteGlosa/',
                                                                                                    success: function(response, opts) {
                                                                                                       var json=fnc.responseExtAjaxRequestMsjError(response);
                                                                                                       if(json.success){                                                                                                               
                                                                                                           storeGlosas.load({
                                                       ...
                                                       buttons:[
                                                               ...
                                                               handler:function(){
                                                                    ...
                                                                    Ext.Ajax.request({
                                                                        ...
                                                                        success: function(response, opts) {
                                                                            var json=fnc.responseExtAjaxRequestMsjError(response);
                                                                            if(json.success){*/
                                                                                fnc.openURL(settingsLocal.AJAX_URI+"BOLE/verBoletaModificadoPDF/?numero="+data.CO_BOLE);
                                                                            /*}
                                                                        }
                                                                    });  */                                                         
                                                               }
                                                           },
                                                           {
                                                               ...
                                                               handler:function(){
                                                                   ...
                                                                   dataUpdate['CO_BOLE']=data.CO_BOLE;
                                                                   dataUpdate[varSendPackage]=package;
                                                                    Ext.Ajax.request({
                                                                        url:settingsLocal.AJAX_URI+'BOLE/update/',
                                                                        params: dataUpdate,
                                                           ...
                                                           },
                                                           {
                                                               ...
                                                               cls:'fac-btn fac-btn-danger btn-size-tiny',
                                                               handler:function(){
                                                                    var params={CO_BOLE:data.CO_BOLE};  
                                                                    params[varSendPackage]=package;
                                                                    Ext.Ajax.request({
                                                                        url:settingsLocal.AJAX_URI+'BOLE/anular/',
                                                                        params: params,
                                                                        success: function(response){
                                                                            var json=fnc.responseExtAjaxRequestMsjError(response);
                                                                            if (json.success){
