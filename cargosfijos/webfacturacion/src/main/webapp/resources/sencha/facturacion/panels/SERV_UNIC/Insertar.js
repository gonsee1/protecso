Ext.onReady(function(){
    fnc.load.ModelsAndStores(["TIPO_FACT","MONE_FACT","PERI_FACT","PROD","SERV_UNIC"],function(){
        fnc.load.scripts(["widgets/comboBoxServicios.js"],function(){            
        var package="Desktop.Facturacion.Panels.SERV_UNIC.Insertar";
        ...
        Ext.define(package,{
            ...
            alias:'widget.Desktop.Facturacion.Panels.SERV_UNIC.Insertar',
            bodyPadding: 5,
            width: 350,
            layout: 'anchor',
            defaults: {
            ...
            buttons: [{
                ...
                handler: function() {
                    ...
                    if (form.isValid()) {
                        var model=new Desktop.Facturacion.Models.SERV_UNIC(form.getFieldValues());
