Ext.onReady(function(){
    fnc.load.ModelsAndStores(["PROD","SERV_UNIC","PROD_PADRE"],function(){
        var package="Desktop.Facturacion.Panels.SERV_UNIC.Administrar";
        var AJAX_URI=settings.AJAX_URI;
        var objDesktop=null;
        var storeData=new Desktop.Facturacion.Stores.SERV_UNIC();
        ...
        Ext.define(package,{ 
            ...
            alias:'widget.Desktop.Facturacion.Panels.SERV_UNIC.Administrar',
            store:storeData,
            columns: [
                /*{ text: 'Codigo',  dataIndex: 'CO_SERV_UNIC' },*/
                { text: 'Nombre',  dataIndex: 'NO_SERV_UNIC' },                
                    ...
                    click:function(){
                        ...
                        if(selected.length==1){
                            ...
                            fnc.createMsgConfirm({
                                msg:'Esta seguro que desea eliminar el item de modulo '+model.data.NO_SERV_UNIC,
                                call:function(btn){
                                    if(btn=='yes'){
                                        store.destroy({
                                            params:model.data,
            ...
            if(objDesktop!==null){ 
                var store= new Ext.data.Store({
                    ...
                    proxy:{
                        ...
                        api: {
                            read:AJAX_URI+'SERV_UNIC/getid/',
                            update:AJAX_URI+'SERV_UNIC/update/',
                        },
                ...
                store.load({
                    ...
                    callback:function(records,operation,success){
                        if (success){
                            var panelForm=Ext.create('Desktop.Facturacion.Panels.SERV_UNIC.Insertar',{
                                 varsInitComponent:{
                                ...
                                buttons: [  {
                                        ...
                                        handler: function() {
                                            ...
                                            if (form.isValid()) {
                                                ...
                                                params['CO_SERV_UNIC']=model.data.CO_SERV_UNIC;
                                                window.disable();
                                                model.save({
