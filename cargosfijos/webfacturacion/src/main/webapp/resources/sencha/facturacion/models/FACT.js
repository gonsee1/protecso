(function(){
    ...
    Ext.define('Desktop.Facturacion.Models.FACT', {
        extend: 'Ext.data.Model',
        AJAX_URI:AJAX_URI,
        fields: [
            {name: 'CO_FACT', type: 'int'},  
            {name: 'CO_CIER', type: 'int'},
            {name: 'CO_NEGO', type: 'int'}, 
                                    
            {name: 'IM_VALO_VENT', type: 'float'},
            {name: 'IM_VALO_DESC', type: 'float'},
            {name: 'IM_VALO_VENT_NETO', type: 'float'},            
            {name: 'IM_IGV', type: 'float'},            
            {name: 'IM_TOTA', type: 'float'},
            {name: 'DE_MONT', type: 'string'},
            {name: 'IM_AJUS_NIGV', type: 'float'},
            {name: 'IM_INST', type: 'float'},
            {name: 'IM_ALQU', type: 'float'},
            {name: 'IM_OTRO', type: 'float'},
            
            {name: 'ST_AFECTO_DETRACCION', type: 'boolean'},
            ...
            {name: 'DE_REF_DIRE_CORR', type: 'string'},
