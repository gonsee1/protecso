(function(){
    var package='Desktop.Facturacion.Widgets.comboBoxServiciosReportes'; 
    Ext.define(package,{
        ...
        initComponent:function(){
            ...
            fnc.load.ModelsAndStores(["PROD","PROD_PADRE"],function(){
                ...
                function createStoreServicio(data){
                	var d = {'CO_PROD':'0','NO_PROD':'Todos'};
                	data.unshift(d);
                	return Ext.create("Ext.data.Store",{
                		fields:[{name:'CO_PROD'},{name:'NO_PROD'}],
                		data:data
                		}
                	);
                }
